...
<script>
	document.addEventListener("DOMContentLoaded", function() {
		...
		document.getElementById("chargetruckid").addEventListener("blur",
				chargetruck);
		document.getElementById("sb").addEventListener("click", send1);
		document.getElementById("search").addEventListener("click", search1);
	});
	function send1() {
		document.insertHighwayData.action = "Update.do";
		document.insertHighwayData.submit();
	}
	function search1() {
		document.insertHighwayData.action = "QueryInformationForUpdateServlet.do";
		document.insertHighwayData.submit();
	}
	function selectId() {
...
<body>
	<form id="insertHighwayData" name="insertHighwayData" action="" method="POST">
		<table border='3'>
			<thead>
				<tr bgcolor='tan'>
			...
			<tbody>
				<tr bgcolor='tan'>
					...
					<td width="400" height="40" align="left"><input
						id='highwaynameid' style="text-align: left" name="highwayname"
						type="text" size="15" value=${query.highwayName}> <span
				...
				<tr bgcolor='tan'>
					...
					<td width="400" height="40" align="left">
						...
						<select name="ndirect" id='directid' value=${query.direct}>
				...
				<tr bgcolor='tan'>
					...
					<td width="400" height="40" align="left"><input name="nnumber"
						id='numberid' type="text" size="12" value=${query.number}>
				...
				<tr bgcolor='tan'>
					...
					<td width="200" height="40" align="left"><input name="ncode"
						id='codeid' type="text" size="12" value=${query.code}>
						<form>
							<span id="show"></span>
						</form> <span id="checkcode"></span>
				...
				<tr bgcolor='tan'>
					...
					<td width="400" height="40" align="left"><input
						...
						value=${query.startPoint}> <span id="checkstartpoint"></span>
				...
				<tr bgcolor='tan'>
					...
					<td width="400" height="40" align="left"><input
						id='endpointid' name="nendpoint" type="text" size="30"
						value=${query.endPoint}> <span id="checkendpoint"></span>
				...
				<tr bgcolor='tan'>
					...
					<td width="400" height="40" align="left"><input
						...
						value=${query.mileCharge}> <span id="checkmilecharge"></span>
				...
				<tr bgcolor='tan'>
					...
					<td width="400" height="40" align="left"><input
						...
						value=${query.chargeSmallcar}> <span
						id="checkchargesmallcar"></span>
				...
				<tr bgcolor='tan'>
					...
					<td width="400" height="40" align="left"><input
						...
						value=${query.chargeBigcar}> <span id="checkchargebigcar"></span>
				...
				<tr bgcolor='tan'>
					...
					<td width="400" height="40" align="left"><input
						...
						value=${query.chargeTruck}> <span id="checkchargetruck"></span>
						<div style="color: #FF0000; font-size: x-small; display: inline">${ErrorMsg.chargetruck}</div>
					</td>
				</tr>
				<tr bgcolor='tan'>
					<td height="50" colspan="2" align="center"><input
						type="button" id="sb" value="送出"><input type="button"
						value="查詢" id="search"></td>
				</tr>
	...
	<script>
		...
		xhttp.open("GET", "SearchHighwayByAjax.do", true);
		xhttp.send();
	</script>
</body>
</html>