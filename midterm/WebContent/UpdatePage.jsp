...
document.addEventListener("DOMContentLoaded", function () {
	document.getElementById("highwaynameid").addEventListener("blur", checkhighwayName);
	document.getElementById("numberid").addEventListener("blur", checknumber);
	document.getElementById("codeid").addEventListener("blur", checkcode);
	document.getElementById("startpointid").addEventListener("blur", startpoint);
	document.getElementById("endpointid").addEventListener("blur", endpoint);
	document.getElementById("milechargeid").addEventListener("blur", milecharge);
	document.getElementById("chargesmallcarid").addEventListener("blur",chargesmallcar);
	document.getElementById("chargebigcarid").addEventListener("blur",chargebigcar);
	document.getElementById("chargetruckid").addEventListener("blur",chargetruck);
});
...
<body>
<form name="insertHighwayData" action="Update.do" method="POST">
	<table border='3'>
		<thead>
			<tr bgcolor='tan'>
				<th height="60" colspan="2" align="center">更新高速公路資料</th>
			</tr>
		</thead>
		<tbody>
			<tr bgcolor='tan'>
				<td width="120" height="40">國道名:</td>
				<td width="400" height="40" align="left"><input id='highwaynameid'
					style="text-align: left" name="highwayname" type="text" size="15">
					<span id="checkHighwayName"></span>
...
<!-- 					style="text-align: left" name="ndirect" type="text" size="1"> -->
			...
			<tr bgcolor='tan'>
				...
				<td width="400" height="40" align="left"><input name="nnumber" id='numberid'
					type="text" size="12">
					<span id="checknumber"></span>
					<p style="font-size: 80%; color: blue;">格式為00F-000.0N，請勿更改編號</p>
			...
			<tr bgcolor='tan'>
				...
				<td width="200" height="40" align="left"><input name="ncode" id='codeid'
					...
					<p style="font-size: 80%; color: blue;">格式為00F0000N，請勿更改代碼</p>
					<div style="color: #FF0000; font-size: x-small; display: inline">${ErrorMsg.code}</div>
				</td>
			</tr>
			<tr bgcolor='tan'>
				<td width="120" height="40">起點交流道:</td>
				<td width="400" height="40" align="left"><input id='startpointid'
					name="nstartpoint" type="text" size="30">
			...
			<tr bgcolor='tan'>
				...
				<td width="400" height="40" align="left"><input id='endpointid'
					name="nendpoint" type="text" size="30">
					<span id="checkendpoint"></span>
					<div style="color: #FF0000; font-size: x-small; display: inline">${ErrorMsg.endpoint}</div>
				</td>
			</tr>
			<tr bgcolor='tan'>
				<td width="120" height="40">收費區設定里程:</td>
				<td width="400" height="40" align="left"><input id='milechargeid'
					name="nmilecharge" type="text" size="5">
			...
			<tr bgcolor='tan'>
				...
				<td width="400" height="40" align="left"><input id='chargesmallcarid'
					name="nchargesmallcar" type="text" size="5">
			...
			<tr bgcolor='tan'>
				...
				<td width="400" height="40" align="left"><input id='chargebigcarid'
					name="nchargebigcar" type="text" size="5">
			...
			<tr bgcolor='tan'>
				...
				<td width="400" height="40" align="left"><input id='chargetruckid'
					name="nchargetruck" type="text" size="5">
